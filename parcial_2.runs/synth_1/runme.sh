...
HD_PWD='C:/Users/diego/OneDrive/Desktop/projects vivado/parcial_2/parcial_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elevador_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elevador_top.tcl
